...
-- Map CMD+SHIFT+0 to Gitsigns next_hunk
vim.api.nvim_set_keymap("n", "<leader>0", ":Gitsigns next_hunk<CR>", { noremap = true, silent = true })

-- Map CMD+SHIFT+9 to Gitsigns prev_hunk
vim.api.nvim_set_keymap("n", "<leader>9", ":Gitsigns prev_hunk<CR>", { noremap = true, silent = true })
